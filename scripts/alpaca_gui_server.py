#!/usr/bin/env python3
"""Alpaca GUI — live FastAPI server.
...
Run (inside venv-shark):
    python scripts/alpaca_gui_server.py        # -> http://127.0.0.1:8808
"""
...
<meta name="viewport" content="width=device-width, initial-scale=1"><title>Alpaca GUI (live)</title>
<style>
  ...
  *{box-sizing:border-box}body{margin:0;font-family:var(--ui);color:var(--ink);background:var(--bg);font-size:14.5px;line-height:1.5;
  ...
  <div class="bar"><div class="g">🧠</div><div><div class="kick">Torch-MLIR Model Zoo · Live Compiler</div>
    <h1><span class="n">Alpaca</span> GUI</h1></div><span class="live" id="live">● live · export_for_npu</span></div>
  <div class="card tool">
  ...
  <footer><span class="m">alpaca</span> · 실동작 서버 · iree_turbine=라이브 · torch_mlir=툴체인 필요</footer>
</main><script>
